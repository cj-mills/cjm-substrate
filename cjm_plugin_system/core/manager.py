...
PluginManager.get_global_stats = get_global_stats
...
PluginManager.get_admission_profile = get_admission_profile
...
PluginManager.get_instance_concurrency_cap = get_instance_concurrency_cap
