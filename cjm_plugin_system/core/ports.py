...
Bindings are `OutputRef` markers inside node kwargs; the DAG topology is
DERIVED from the markers, member jobs are created lazily when a node's
dependencies complete, and field extraction is centralized in the single
substrate-owned successor of the retired per-consumer `field_of` helpers.

Docs: https://cj-mills.github.io/cjm-plugin-systemcore/ports.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core/ports.ipynb.

# %% auto #0
__all__ = ['logger', 'TERMINAL_NODE_STATES', 'NodeState', 'OutputRef', 'CompositionNode', 'Composition',
           'CompositionValidationError', 'validate_composition', 'CompositionBindingError', 'extract_output_field',
           'resolve_node_kwargs', 'CompositionNodeRun', 'CompositionRun', 'new_composition_run', 'ready_nodes',
           'record_started', 'record_result', 'skip_dependents', 'all_terminal', 'derive_terminal_status',
           'results_by_node']

# %% ../../nbs/core/ports.ipynb #ports-imports
import logging
...
# %% ../../nbs/core/ports.ipynb #ports-nodestate
...
# %% ../../nbs/core/ports.ipynb #ports-outputref
...
# %% ../../nbs/core/ports.ipynb #ports-compnode
@dataclass
...
# %% ../../nbs/core/ports.ipynb #ports-node-deps
...
# %% ../../nbs/core/ports.ipynb #ports-validate
...
# %% ../../nbs/core/ports.ipynb #ports-binding-error
...
# %% ../../nbs/core/ports.ipynb #ports-resolve-kwargs
...
# %% ../../nbs/core/ports.ipynb #ports-noderun
@dataclass
...
# %% ../../nbs/core/ports.ipynb #ports-comprun
@dataclass
...
# %% ../../nbs/core/ports.ipynb #ports-new-run
...
# %% ../../nbs/core/ports.ipynb #ports-fn-ready-nodes
def ready_nodes(
    self: CompositionRun,
...
CompositionRun.ready_nodes = ready_nodes

# %% ../../nbs/core/ports.ipynb #ports-fn-record-started
def record_started(
    self: CompositionRun,
...
CompositionRun.record_started = record_started

# %% ../../nbs/core/ports.ipynb #ports-fn-record-result
def record_result(
    self: CompositionRun,
...
CompositionRun.record_result = record_result

# %% ../../nbs/core/ports.ipynb #ports-fn-skip-dependents
def skip_dependents(
    self: CompositionRun,
...
CompositionRun.skip_dependents = skip_dependents

# %% ../../nbs/core/ports.ipynb #ports-fn-all-terminal
def all_terminal(
    self: CompositionRun,
...
CompositionRun.all_terminal = all_terminal

# %% ../../nbs/core/ports.ipynb #ports-fn-derive-status
...
CompositionRun.derive_terminal_status = derive_terminal_status

# %% ../../nbs/core/ports.ipynb #ports-fn-results-by-node
def results_by_node(
    self: CompositionRun,
...
CompositionRun.results_by_node = results_by_node

# %% ../../nbs/core/ports.ipynb #ports-all-curation
...
# being last.
__all__ = [
    'NodeState', 'TERMINAL_NODE_STATES',
    'OutputRef', 'CompositionNode', 'Composition',
    'CompositionValidationError', 'CompositionBindingError',
    'validate_composition', 'extract_output_field', 'resolve_node_kwargs',
    'CompositionNodeRun', 'CompositionRun', 'new_composition_run',
]
