...
Docs: https://cj-mills.github.io/cjm-plugin-systemcore/config.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core/config.ipynb.

# %% auto #0
__all__ = ['RuntimeMode', 'CondaType', 'RuntimeConfig', 'SubstrateConfig', 'CJMConfig', 'load_config', 'get_config', 'set_config',
           'reset_config']

# %% ../../nbs/core/config.ipynb #exports
import os
...
# %% ../../nbs/core/config.ipynb #runtime-config
@dataclass
class RuntimeConfig:
...
# %% ../../nbs/core/config.ipynb #load-config
def load_config(
...
# %% ../../nbs/core/config.ipynb #accessors
