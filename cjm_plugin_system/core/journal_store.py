...
Docs: https://cj-mills.github.io/cjm-plugin-systemcore/journal_store.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core/journal_store.ipynb.

# %% auto #0
__all__ = ['LIVENESS_EVENT_TYPES', 'SubstrateEventType', 'JournalEvent', 'JournalStore', 'LocalJournalStore']
...
# %% ../../nbs/core/journal_store.ipynb #substrate-event-type
...
# %% ../../nbs/core/journal_store.ipynb #journal-event
@dataclass
class JournalEvent:
...
# %% ../../nbs/core/journal_store.ipynb #store-protocol
@runtime_checkable
...
# %% ../../nbs/core/journal_store.ipynb #imports-patch
from fastcore.basics import patch


# %% ../../nbs/core/journal_store.ipynb #local-schema
_JOURNAL_SCHEMA = """
...
# %% ../../nbs/core/journal_store.ipynb #local-class
...
# %% ../../nbs/core/journal_store.ipynb #m-conn
@patch
@contextmanager
...
# %% ../../nbs/core/journal_store.ipynb #m-query
@patch
def query(
    self: LocalJournalStore,
...
# %% ../../nbs/core/journal_store.ipynb #m-count
@patch
def count(
    self: LocalJournalStore,
...
# %% ../../nbs/core/journal_store.ipynb #m-terminal
@patch
