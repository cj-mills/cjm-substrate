...
Docs: https://cj-mills.github.io/cjm-plugin-systemcore/diagnostics_store.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/core/diagnostics_store.ipynb.

# %% auto #0
__all__ = ['DiagnosticRecord', 'StreamChunk', 'DiagnosticsStore', 'LocalDiagnosticsStore', 'DiagnosticsLogHandler',
           'install_worker_diagnostics', 'normalize_stream_line']

# %% ../../nbs/core/diagnostics_store.ipynb #exports
import logging
import os
import sqlite3
import threading
...
# %% ../../nbs/core/diagnostics_store.ipynb #diagnostic-record
@dataclass
...
# %% ../../nbs/core/diagnostics_store.ipynb #stream-chunk
@dataclass
class StreamChunk:
...
# %% ../../nbs/core/diagnostics_store.ipynb #store-protocol
@runtime_checkable
...
# %% ../../nbs/core/diagnostics_store.ipynb #imports-patch
from fastcore.basics import patch


# %% ../../nbs/core/diagnostics_store.ipynb #local-schema
_DIAGNOSTICS_SCHEMA = """
...
# %% ../../nbs/core/diagnostics_store.ipynb #local-class
...
# %% ../../nbs/core/diagnostics_store.ipynb #m-append-chunk
@patch
def append_chunk(
    self: LocalDiagnosticsStore,
...
# %% ../../nbs/core/diagnostics_store.ipynb #m-query-records
@patch
def query_records(
    self: LocalDiagnosticsStore,
...
# %% ../../nbs/core/diagnostics_store.ipynb #m-query-chunks
@patch
def query_chunks(
    self: LocalDiagnosticsStore,
    worker_session_id: Optional[str] = None,  # Session scope
...
# %% ../../nbs/core/diagnostics_store.ipynb #m-retention
@patch
def apply_retention(
    self: LocalDiagnosticsStore,
...
# %% ../../nbs/core/diagnostics_store.ipynb #log-handler
...
# %% ../../nbs/core/diagnostics_store.ipynb #install-fn
...
# %% ../../nbs/core/diagnostics_store.ipynb #normalize-line
