...
from cjm_substrate.core.wire import (ACCOUNTS_HEADER, begin_account_capture, CallEnvelope,
                                     drain_accounts, ENVELOPE_BODY_KEY, record_account,
                                     set_call_envelope, wire_encode)
...
def run_worker() -> None:
    ...
    Typically launched by the RemoteCapabilityProxy, e.g.:
    ...
    `--ppid` enables the suicide pact: if that process dies, this worker
    terminates itself (see `parent_monitor`).
    """
