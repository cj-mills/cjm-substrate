"""One-call factory that assembles a CapabilityManager + JobQueue + capability
bindings — closes the ~70-line demo-app boilerplate duplication audited across
5 substrate consumers."""
...
from cjm_substrate.core.scheduling import ResourceScheduler
...
class Pipeline:
    ...
    Async context-manager semantics for ergonomic teardown::
    ...
    Exit calls `queue.stop()` + `manager.unload_all()`.
    """
